...
namespace :murax do
  desc 'Search and replace the depositor to another'
  task :update_depositor_by_work_id, [:search, :replace, :workids] => :environment do |task, args|
        ...
        workids.each do |wid|
           begin 
             ...
             if solr_hit.nil?
                ...
                obj.depositor = 'dev.library@mcgill.ca'
                obj.save!
                count+=1
             end
