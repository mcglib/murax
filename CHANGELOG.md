...
* Fixed: ADIR-1407 - Fixed dependecies that has security vulnerabilities for some packages.

## [2.0.10] - 2023-07-03

* Updated: The rake task that deleted the works by work ids also send an email with work ids list. ADIR-1394
* Fixed: Google analytics bug by adding commenting out line# 59  config/initializers/hyrax.rb.

## [2.0.9] - 2023-05-30

* Fixed: ADIR-1393 - Fixed dependecies that has security vulnerabilities for some packages.

## [2.0.8] - 2023-04-05

* Added: Rake tasks that deles the works by work ids. ADIR-1389

## [2.0.7] - 2023-03-29

* Fixed: ADIR-1375 - PMID field to show correct value.
* Fixed: ADIR-1381 - Grant number field now shows publicly.
* Fixed: Few text changes on homepage as requested.

## [2.0.6] - 2023-02-27

* Fixed: ADIR-1371 - Fixing typo on the analytics file path

## [2.0.5] - 2023-02-27

* Fixed: ADIR-1371 -  Add google analytics to deploy process
